# ASCENSION — Android Packaging Build

**Game lineage:** ASCENSION  
**Status:** Android / Play Store packaging and QA repository  
...
The canonical public game identity and source description are maintained in `Joenasriani/ascension-opt`.

Existing branches and historical files are retained as development and release history.